  ...
  return (
    <div className="explore-page page-frame">
      ...
      <section className="explore-domain">
        <div className="domain-intro"><span>01</span><div><p className="eyebrow">{t("explore.foundation")}</p><h2>{graph.nodes.find((node) => node.id === "business-core")?.title}</h2><p>{t("explore.businessCoreSummary")}</p></div><Link href="/skala">{t("explore.territory")}</Link></div>
