...
export const aiCopilotEconomicsCase = caseDefinitionSchema.parse({
  ...
  title: l("La economía de un copiloto de IA", "The economics of the copilot"),
  ...
  context: {
    ...
    premise: l("El piloto genera valor, pero cada interacción tiene un costo variable. Antes de lanzar, debes definir el producto, el modelo de precios y las capacidades que conviene mantener dentro de la empresa.", "The pilot creates real value, but every interaction carries variable cost. You must choose a product, pricing and capability architecture before committing to launch."),
  },
  sections: [
    {
      id: "brief", label: l("Contexto", "Brief"), title: l("La decisión", "The decision"),
      body: l("NexoDesk vende software de atención al cliente a empresas medianas. El comité quiere anunciar un copiloto el próximo trimestre, pero todavía no decide si comprar o desarrollar la capa de IA ni cómo cobrar por ella.", "NexoDesk sells customer-support software to mid-market companies. The committee wants to announce a copilot next quarter, but has not decided whether to buy the AI layer, build it, or how to charge for it."),
      metrics: [
    ...
    },
    {
      ...
      body: l("La investigación comercial sugiere cobrar US$12 adicionales por cada usuario activo. El proveedor cobra principalmente por uso y los agentes de uso intensivo consumen cerca de cuatro veces el promedio.", "Commercial research supports a US$12 add-on per active seat. The vendor charges primarily by usage and intensive agents consume nearly four times the average."),
      metrics: [
        ...
        { label: l("Margen del complemento", "Add-on margin"), value: "35%", note: l("antes de soporte", "before support") },
      ],
    },
    {
      id: "options", label: l("Opciones", "Options"), title: l("Tres caminos plausibles", "Three plausible paths"),
      body: l("Comprar permite lanzar en ocho semanas, con US$120 mil de implementación y un mínimo anual de US$180 mil. Desarrollar internamente requiere siete meses y US$900 mil durante el primer año, con un costo objetivo de US$4,10 por usuario. Una alternativa combinada puede contratar la inferencia y mantener dentro de NexoDesk la evaluación, la selección de modelos y la experiencia de producto.", "Buying enables an eight-week launch with US$120k implementation and a US$180k annual minimum. Building requires seven months and US$900k in year one, with a target cost of US$4.10 per user. A hybrid can buy inference while owning evaluation, routing and product experience."),
      metrics: [
        ...
        { label: l("Equipo disponible", "Available team"), value: "4", note: l("desarrolladores; sin experiencia operando modelos", "backend; no ML Ops") },
      ],
    },
    {
      id: "inbox", label: l("Comité", "Inbox"), title: l("Las exigencias del comité", "What the committee is testing"),
      body: l("Ventas quiere anunciar antes que un competidor. Finanzas exige una ruta para alcanzar 65% de margen en el complemento. Legal acepta al proveedor si los datos, las evaluaciones y el historial de instrucciones pueden trasladarse a otra solución. Operaciones teme que el promedio del piloto oculte segmentos costosos.", "Sales wants to announce before a competitor. Finance requires a path to 65% margin for the add-on. Legal accepts the vendor if data, evaluations and prompt history remain portable. Operations fears the pilot average hides expensive segments."),
      metrics: [
        ...
        { label: l("Legal", "Legal"), value: "Portabilidad", note: l("condición de aprobación", "approval condition") },
      ],
    },
  ],
  newInformation: {
    usageShock: { title: l("El promedio ocultaba un segmento muy costoso", "The average hid an expensive tail"), body: l("Los agentes del 10% de mayor uso consumen 3,2 veces más de lo proyectado. Su costo estimado sube a US$13,40 al mes y supera el precio propuesto de US$12.", "Agents in the top usage decile consume 3.2× more than projected. Their estimated monthly cost rises to US$13.40, above the proposed US$12 price."), implication: l("Debes decidir si cambias el precio, los límites de uso, la selección de modelos o el segmento objetivo.", "You must decide whether to change pricing, usage limits, routing or the target segment.") },
    competitorWindow: { title: l("La ventana se acorta", "The window narrows"), body: l("Un competidor anunció un copiloto para dentro de diez semanas y catorce grandes empresas preguntaron si NexoDesk lo tendrá disponible este trimestre.", "A competitor announced a copilot for ten weeks from now and fourteen enterprise accounts asked about availability this quarter."), implication: l("Debes estimar de manera explícita cuánto aprendizaje o ingreso se perdería por esperar.", "You must explicitly value what learning or revenue is lost by waiting.") },
    ...
    portabilityTest: { title: l("La portabilidad tiene límites", "Portability has a boundary"), body: l("El proveedor permite exportar los datos, pero no sus evaluaciones ni sus reglas para seleccionar modelos. Recrearlas tomaría entre tres y cuatro meses.", "The vendor exports data, but its evaluations and routing rules do not transfer. Recreating them would take three to four months."), implication: l("Una alternativa combinada sólo es reversible si defines qué activos permanecerán bajo el control de NexoDesk.", "A hybrid model is reversible only if you define which assets remain under NexoDesk's control.") },
  },
...
const copy = {
  "es-CL": {
    ...
    intro: { eyebrow: "LABORATORIO DE DECISIONES", youAre: "TU ROL", enter: "Entrar al caso", synthetic: "Caso ficticio · Todos los datos pertenecen a esta simulación" },
    evidence: { eyebrow: "EVIDENCIA", title: "Construye tu lectura antes de decidir", body: "Contrasta las cinco fuentes. No todas tienen el mismo peso y algunas tensiones no se resuelven con una sola métrica.", viewed: "REVISADO", cited: "EN LA TESIS", unread: "POR REVISAR", continue: "Formar una tesis", requirement: "Revisa al menos cuatro fuentes e incorpora dos a tu tesis." },
    initial: { eyebrow: "DECISIÓN INICIAL", title: "¿Qué recomendarías hoy?", body: "Elige una alternativa que puedas defender con la evidencia disponible. Más adelante podrás revisarla.", prompt: "Recomendación inicial", rationale: "Explica tu postura en 3–5 líneas", rationalePlaceholder: "Conecta la evidencia, los costos o renuncias y el supuesto principal…", evidencePrompt: "Selecciona al menos dos fuentes que respalden tu postura", risk: "¿Cuál es el principal riesgo que estás dispuesto a aceptar?", riskPlaceholder: "El riesgo más importante es…", submit: "Enviar decisión al comité" },
    challenge: { eyebrow: "DESAFÍO DE SKALA", title: "Pon a prueba el supuesto principal de tu postura", context: "Skala formuló esta pregunta a partir de tu recomendación.", placeholder: "Responde en 2–4 líneas. Puedes defender, acotar o modificar tu postura…", submit: "Responder al desafío" },
    newInfo: { eyebrow: "NUEVA INFORMACIÓN", title: "El contexto de la decisión cambió", notCorrection: "Esto no significa que tu decisión anterior estuviera equivocada. Evalúa si la nueva información modifica sus costos o renuncias.", continue: "Revisar mi postura" },
    ...
    final: { eyebrow: "RECOMENDACIÓN FINAL", title: "Escribe para el comité", body: "Cierra con una recomendación ejecutiva y una condición observable que obligaría a revisarla.", recommendation: "Recomendación ejecutiva", recommendationPlaceholder: "Recomiendo… porque… El costo o renuncia que aceptamos es…", trigger: "Condición de revisión", triggerPlaceholder: "Revisaremos esta decisión si…", submit: "Evaluar mi razonamiento", evaluating: "Evaluando según la rúbrica…" },
    result: { eyebrow: "EVALUACIÓN COMPLETA", title: "La calidad se demuestra en el razonamiento", overall: "DESEMPEÑO GLOBAL", strength: "FORTALEZA PRINCIPAL", improvement: "PRÓXIMA MEJORA", trajectory: "EVOLUCIÓN DE LA DECISIÓN", evidence: "EVIDENCIA GENERADA", mastery: "CAMBIO EN TU SKALA", before: "Antes", after: "Ahora", distinction: "Completar el caso genera evidencia de aplicación bajo presión. Una sola evidencia no equivale a expertise comprobado.", openGraph: "Ver el cambio en Tu Skala", backCases: "Volver a Casos" },
  ...
  en: {
    ...
    evidence: { eyebrow: "EVIDENCE", title: "Build your reading before deciding", body: "Compare all five sources. They do not carry equal weight and some tensions cannot be resolved with one metric.", viewed: "REVIEWED", cited: "IN THESIS", unread: "TO REVIEW", continue: "Form a thesis", requirement: "Review at least four sources and add two to your thesis." },
