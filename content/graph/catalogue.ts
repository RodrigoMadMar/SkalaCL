...
export const clusters: ClusterSeed[] = [
  {
    ...
    skills: [
      ...
      { id: "pricing-strategy", title: "Pricing strategy", summary: "Select a price architecture that captures value without damaging adoption.", related: ["elasticity", "unit-economics"], status: "playable" },
  ...
  },
  {
    ...
    skills: [
      ...
      { id: "unit-economics", title: "Unit economics", summary: "Model the revenue and variable cost created by one customer or transaction.", prerequisites: ["financial-statements"], status: "validated" },
  ...
  },
  {
    ...
    skills: [
      { id: "ai-models-products", title: "Models vs products", summary: "Distinguish a model capability from the product system that delivers value.", status: "validated" },
      { id: "ai-training-inference", title: "Training vs inference", summary: "Separate how models are created from how they produce outputs in use.", prerequisites: ["ai-models-products"], status: "playable" },
      { id: "ai-tokens-context", title: "Tokens & context", summary: "Understand how context windows shape cost, memory and behavior.", prerequisites: ["ai-models-products"], status: "playable" },
      { id: "ai-capability-workflow", title: "Model vs workflow capability", summary: "Locate performance in the model, tools, data and surrounding workflow.", prerequisites: ["ai-models-products"], status: "outlined" },
      { id: "ai-evaluation-basics", title: "Evaluation basics", summary: "Define representative tests before trusting apparent model quality.", prerequisites: ["ai-models-products"], status: "playable" },
  ...
  },
  {
    ...
    skills: [
      { id: "ai-inference-economics", title: "Inference economics", summary: "Explain how usage-driven model cost changes pricing and gross margin.", prerequisites: ["ai-training-inference", "unit-economics"], related: ["marginal-cost"], status: "validated" },
  ...
  },
  {
    ...
    skills: [
      { id: "ai-copilot-agent", title: "Copilot vs agent", summary: "Match autonomy to task risk, reversibility and verification cost.", prerequisites: ["ai-models-products"], status: "validated" },
      ...
      { id: "ai-ux", title: "AI interaction design", summary: "Design interfaces for variable output, iteration and progressive control.", prerequisites: ["ai-models-products"], status: "playable" },
  ...
  },
  {
    ...
    skills: [
      { id: "ai-org-redesign", title: "Organizational redesign", summary: "Reshape roles and interfaces around a changed division of labor.", prerequisites: ["organizational-design", "ai-models-products"], status: "validated" },
      ...
      { id: "ai-task-allocation", title: "Human–AI task allocation", summary: "Allocate work by comparative strength, context and accountability.", prerequisites: ["ai-models-products"], status: "playable" },
